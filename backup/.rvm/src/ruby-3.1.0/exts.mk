...
extensions = ext/-test-/RUBY_ALIGNOF/. ext/-test-/arith_seq/extract/. \
	     ...
	     ext/-test-/symbol/. ext/-test-/thread_fd/. \
	     ext/-test-/time/. ext/-test-/tracepoint/. \
	     ext/-test-/typeddata/. ext/-test-/vm/. ext/-test-/wait/. \
	     ext/bigdecimal/. ext/cgi/escape/. ext/continuation/. \
	     ext/coverage/. ext/date/. ext/digest/. \
	     ext/digest/bubblebabble/. ext/digest/md5/. \
	     ext/digest/rmd160/. ext/digest/sha1/. ext/digest/sha2/. \
	     ext/etc/. ext/fcntl/. ext/fiddle/. ext/io/console/. \
	     ext/io/nonblock/. ext/io/wait/. ext/json/. \
	     ext/json/generator/. ext/json/parser/. ext/monitor/. \
