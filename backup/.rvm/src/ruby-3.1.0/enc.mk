...
encsrcdir = ./enc
topdir = .
prefix = /Users/edsonma/.rvm/rubies/ruby-3.1.0
exec_prefix = $(prefix)
...
OUTFLAG = -o $(empty)
COUTFLAG = -o $(empty)
CFLAGS = $(CCDLFLAGS) -O3 -I/usr/local/opt/libyaml/include -I/usr/local/opt/libksba/include -I/usr/local/opt/readline/include -I/usr/local/opt/zlib/include -I/usr/local/opt/openssl@1.1/include $(cflags) -fno-common -pipe 
...
DEFS = 
CPPFLAGS = -D_XOPEN_SOURCE -D_DARWIN_C_SOURCE -D_DARWIN_UNLIMITED_SELECT -D_REENTRANT $(DEFS) $(cppflags) -DONIG_ENC_REGISTER=rb_enc_register
...
LIBPATH =  -L. -L$(topdir)
LIBS = $(LIBRUBYARG_SHARED)  $(EXTLIBS)
